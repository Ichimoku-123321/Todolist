...
const FeatureCard = ({ icon, title, desc }: FeatureCardProps) => (
  <div className="glass-panel group relative overflow-hidden hover:bg-black/80 transition-all duration-500 rounded-xl flex flex-col
    p-6 
    3xl:p-10 
    5xl:p-16 5xl:rounded-3xl
    7xl:p-24 7xl:rounded-[3rem]
    9xl:p-40 9xl:rounded-[5rem]
  ">
    ...
    <div className="bg-black border border-white/10 flex items-center justify-center mb-6 group-hover:border-amber-500/50 transition-colors duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)] rounded-lg
      w-14 h-14 
    ...
    <h3 className="font-cinzel font-bold text-white mb-3 group-hover:text-amber-400 transition-colors
      text-xl 
      3xl:text-2xl 
      5xl:text-4xl 5xl:mb-6
      7xl:text-6xl 7xl:mb-10
      9xl:text-8xl 9xl:mb-16
    ">{title}</h3>
    
    <p className="font-inter text-slate-500 leading-relaxed group-hover:text-slate-400 transition-colors
      text-sm 
      3xl:text-lg 
      5xl:text-2xl 5xl:leading-normal
      7xl:text-4xl 7xl:leading-normal
      9xl:text-6xl 9xl:leading-normal
    ">
      {desc}
    </p>
    ...
    ">
      <div className="max-w-7xl 3xl:max-w-[90vw] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center 
          ...
          9xl:mb-[30rem]
        ">
          <h2 className="font-cinzel font-bold text-white mb-4
            text-4xl 
            3xl:text-5xl 
            5xl:text-7xl 5xl:mb-10
            7xl:text-9xl 7xl:mb-16
            9xl:text-[14rem] 9xl:mb-24
        ...
        ">
          <FeatureCard 
            icon={<Zap className="w-6 h-6 3xl:w-10 3xl:h-10 5xl:w-16 5xl:h-16 7xl:w-24 7xl:h-24 9xl:w-40 9xl:h-40 text-amber-400" />}
            title="Бесплатно"
            desc="Могущество не продается. Оно берется. Доступ открыт для достойных."
          />
          <FeatureCard 
            icon={<Share2 className="w-6 h-6 3xl:w-10 3xl:h-10 5xl:w-16 5xl:h-16 7xl:w-24 7xl:h-24 9xl:w-40 9xl:h-40 text-purple-400" />}
            title="Связи"
            desc="Распространяй влияние. Делись списками через зашифрованные каналы."
          />
          <FeatureCard 
            icon={<ShieldCheck className="w-6 h-6 3xl:w-10 3xl:h-10 5xl:w-16 5xl:h-16 7xl:w-24 7xl:h-24 9xl:w-40 9xl:h-40 text-amber-400" />}
            title="Анонимность"
            desc="Твои данные скрыты в пустоте. Никто не узнает твоих планов."
          />
          <FeatureCard 
            icon={<LayoutDashboard className="w-6 h-6 3xl:w-10 3xl:h-10 5xl:w-16 5xl:h-16 7xl:w-24 7xl:h-24 9xl:w-40 9xl:h-40 text-purple-400" />}
            title="Контроль"
