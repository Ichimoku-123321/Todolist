...
const NavLink = ({ href, text, active }: NavLinkProps) => (
  <a 
    ...
    className={`relative font-cinzel font-semibold tracking-wide transition-colors duration-300 group
      py-1 text-sm 
      3xl:text-lg 
      5xl:text-2xl 5xl:py-2
      7xl:text-4xl 7xl:py-4
      9xl:text-6xl 9xl:py-6
...
const MobileNavLink = ({ text, active }: { text: string; active?: boolean }) => (
  <a 
    href="#" 
    className={`block px-4 py-3 border-l-2 text-base font-cinzel font-medium transition-colors ${
...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-amber-500/10">
      <div className="max-w-7xl 3xl:max-w-[95vw] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        ">
          {/* Logo */}
          <a href="#" className="flex items-center gap-3 5xl:gap-6 7xl:gap-10 9xl:gap-16 group">
            ...
            <div className="flex flex-col">
              <span className="font-cinzel font-bold tracking-[0.2em] text-white
                text-xl 
                3xl:text-2xl 
                5xl:text-4xl 
                7xl:text-6xl
              ...
              <span className="text-amber-500 font-playfair uppercase
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden glass-panel border-t border-amber-500/10 absolute w-full bg-black/95">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4">
              <button className="w-full flex justify-center items-center gap-2 bg-amber-600/20 border border-amber-500/50 text-amber-400 px-4 py-3 rounded-none font-cinzel cursor-pointer">
                <CheckSquare size={18} />
